...
/// <summary>
/// Sync-loop knobs. Binds to the <c>Sync</c> config section; on the server
...
public sealed class SyncOptions
{
    ...
    /// <summary>Fast-loop period in minutes (PLAN §7: 15).</summary>
    public int FastLoopMinutes { get; set; } = 15;

    /// <summary>Nightly full re-check time, <c>HH:mm</c> UTC (PLAN §7).</summary>
