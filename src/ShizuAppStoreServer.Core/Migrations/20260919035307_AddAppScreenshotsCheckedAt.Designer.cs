...
namespace ShizuAppStoreServer.Core.Migrations
{
    ...
    [Migration("20260919035307_AddAppScreenshotsCheckedAt")]
    partial class AddAppScreenshotsCheckedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShizuAppStoreServer.Core.Data.App", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("InstallCountUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("install_count_updated_at");
                    ...
                    b.Property<DateTimeOffset?>("ListUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<DateTimeOffset?>("ScreenshotsCheckedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("screenshots_checked_at");
            ...
            modelBuilder.Entity("ShizuAppStoreServer.Core.Data.AppDownload", b =>
                {
                    ...
                    b.HasIndex("AppId", "PackageName", "SigKey", "Abi")
                        .IsUnique();

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("AppId", "PackageName", "SigKey", "Abi"), false);

                    b.ToTable("app_downloads", (string)null);
                });

            modelBuilder.Entity("ShizuAppStoreServer.Core.Data.AppDownloadExclusion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("AppSlug", "PackageName")
                        .IsUnique();

                    b.ToTable("app_download_exclusions", (string)null);
                });
            ...
            modelBuilder.Entity("ShizuAppStoreServer.Core.Data.SyncIssue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("sync_issues", (string)null);
                });
            ...
            modelBuilder.Entity("ShizuAppStoreServer.Core.Data.SyncIssue", b =>
                {
                    ...
                    b.HasOne("ShizuAppStoreServer.Core.Data.SyncRun", "SyncRun")
                        .WithMany()
