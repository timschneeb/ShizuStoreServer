...
public sealed class GitHistoryServiceTests
{
    private const string Log = """
        COMMIT:1111111111111111111111111111111111111111|2022-10-09T05:25:39+02:00
        ...
        COMMIT:2222222222222222222222222222222222222222|2023-05-01T10:00:00+02:00
        diff --git a/README.md b/README.md
        --- a/README.md
        +++ b/README.md
        @@ -1,2 +1,3 @@
        ...
        COMMIT:3333333333333333333333333333333333333333|not-a-date
    ...
    public void ParseLogTakesFirstLinkPerLine()    {
        const string log = """
            COMMIT:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa|2024-01-02T03:04:05+01:00
